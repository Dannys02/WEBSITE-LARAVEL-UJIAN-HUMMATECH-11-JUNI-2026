        ...
        <form method="GET" action="{{ route('borrowed.index') }}" class="flex gap-3 flex-col md:flex-row">
            <div class="flex-1 relative">
                <input type="text" name="search" value="{{ request('search') }}"
                    ...
                    class="w-full px-4 py-2.5 pl-11 border border-slate-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 outline-none transition-all text-sm bg-slate-50 hover:bg-slate-100 focus:bg-white">
                ...
                <tbody class="divide-y divide-slate-200">
                    ...
                    <tr class="hover:bg-slate-50/80 transition-colors group">
                        ...
                        <td class="px-6 py-4 text-sm text-slate-600">
                            ...
                            @endphp
                            <div class="font-medium text-xs text-orange-700 bg-orange-50 ring-1 ring-orange-600/20 px-2.5 py-1 rounded-full inline-flex items-center gap-1 mb-1.5">
                        ...
                        <td class="px-6 py-4 text-sm">
                            ...
                            @else
                            <span class="inline-flex items-center gap-1 px-2.5 py-1 bg-orange-50 text-orange-700 ring-1 ring-orange-600/20 rounded-full text-xs font-semibold">
