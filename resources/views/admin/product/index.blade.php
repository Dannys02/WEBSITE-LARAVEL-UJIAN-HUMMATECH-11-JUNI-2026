...
@section('content')
    <div class="space-y-6">
        ...
        <!-- Form Tambah/Edit Produk (Inline di atas) -->
        <div id="productFormCard" class="bg-white border border-gray-200 rounded-lg shadow-sm p-6 transition-all">
            ...
            <form id="productForm" method="POST" action="{{ route('products.store') }}" class="space-y-4" enctype="multipart/form-data">
                @csrf
                        ...
                        @forelse($products as $product)
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-6 py-4 text-sm text-gray-600">
                                    ...
                                    @else
                                        <div class="bg-gray-100 border border-dashed rounded-md w-12 h-12 flex items-center justify-center text-[10px] text-gray-400 font-semibold uppercase">No Image</div>
                                    @endif
                                </td>
                                ...
                                <td class="px-6 py-4 text-sm text-gray-600">
                                    <span class="inline-block px-2 py-0.5 {{ $product->stock > 10 ? 'bg-green-50 text-green-700' : ($product->stock > 0 ? 'bg-amber-50 text-amber-700' : 'bg-red-50 text-red-700') }} rounded text-xs font-semibold">
                                        {{ $product->stock }} Unit
                                    </span>
                                </td>
    ...
    <script>
        ...
        function editProduct(id, name, category, stock, price_per_day, description) {
