...
<body class="bg-black text-gray-100 font-sans antialiased">
    ...
    <section id="home" class="relative w-full h-screen flex items-center justify-center overflow-hidden pt-20">
        ...
        <div class="absolute inset-0">
            <img src="https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?w=1600&q=80"
                 alt="Event Equipment" class="w-full h-full object-cover">
        ...
        <div class="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h1 class="text-5xl md:text-7xl font-bold mb-6 text-white leading-tight">
                ...
                <span class="bg-gradient-to-r from-blue-400 to-blue-600 bg-clip-text text-transparent">Profesional</span>
            </h1>
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center mb-16">
                ...
                <button class="px-8 py-3 rounded-lg font-semibold text-blue-400 border-2 border-blue-400 hover:bg-blue-400 hover:text-black transition-all duration-300">
                    Pesan Sekarang
                </button>
            </div>
    ...
    <section class="py-20 bg-slate-900">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
                ...
                <div class="card-hover bg-gradient-to-br from-slate-800 to-slate-900 rounded-xl p-6 text-center cursor-pointer border border-slate-700 hover:border-blue-500">
                ...
                <div class="card-hover bg-gradient-to-br from-slate-800 to-slate-900 rounded-xl p-6 text-center cursor-pointer border border-slate-700 hover:border-blue-500">
                    <div class="mb-4 flex justify-center">
                        <svg class="w-12 h-12 text-yellow-400" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M9 21c0 .55.45 1 1 1h4c.55 0 1-.45 1-1v-1H9v1zm3-20C5.13 1 2 4.13 2 8c0 2.38 1.19 4.47 3 5.74V17c0 .55.45 1 1 1h12c.55 0 1-.45 1-1v-3.26c1.81-1.27 3-3.36 3-5.74 0-3.87-3.13-7-7-7zm0 2c2.76 0 5 2.24 5 5s-2.24 5-5 5-5-2.24-5-5 2.24-5 5-5z"/>
                        </svg>
                    </div>
                ...
                <div class="card-hover bg-gradient-to-br from-slate-800 to-slate-900 rounded-xl p-6 text-center cursor-pointer border border-slate-700 hover:border-blue-500">
                    <div class="mb-4 flex justify-center">
                        <svg class="w-12 h-12 text-pink-400" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M21 3H3c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h18c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H3V5h18v14zm-10-7l-5 5h3v3h4v-3h3l-5-5z"/>
                        </svg>
                    </div>
                ...
                <div class="card-hover bg-gradient-to-br from-slate-800 to-slate-900 rounded-xl p-6 text-center cursor-pointer border border-slate-700 hover:border-blue-500">
                    <div class="mb-4 flex justify-center">
                        <svg class="w-12 h-12 text-cyan-400" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M20 3H4c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H4V5h16v14zm-6-4l-4-4-4 4-3-3v8h16V8l-5 5z"/>
                        </svg>
                    </div>
    ...
    <section id="products" class="py-20 bg-black">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="card-hover bg-gradient-to-br from-slate-900 to-slate-950 rounded-xl overflow-hidden border border-slate-800">
                    <div class="relative">
                        ...
                        <div class="absolute top-4 right-4">
                            <span class="bg-green-500 text-white px-3 py-1 rounded-full text-xs font-bold">Tersedia</span>
                        </div>
                    </div>
                    <div class="p-6">
                ...
                <div class="card-hover bg-gradient-to-br from-slate-900 to-slate-950 rounded-xl overflow-hidden border border-slate-800">
                    <div class="relative">
                        ...
                        <div class="absolute top-4 right-4">
                            <span class="bg-yellow-500 text-black px-3 py-1 rounded-full text-xs font-bold">Terbatas</span>
                        </div>
                    </div>
                    <div class="p-6">
                ...
                <div class="card-hover bg-gradient-to-br from-slate-900 to-slate-950 rounded-xl overflow-hidden border border-slate-800">
                    <div class="relative">
                        ...
                        <div class="absolute top-4 right-4">
                            <span class="bg-red-500 text-white px-3 py-1 rounded-full text-xs font-bold">Maintenance</span>
                        </div>
                    </div>
                    <div class="p-6">
                        ...
                        <button disabled class="w-full mt-4 px-4 py-2 rounded-lg font-semibold text-gray-500 bg-gray-800 cursor-not-allowed">
                            Sedang Diperbaiki
                        </button>
                    </div>
                </div>
    ...
    <section class="py-20 bg-slate-950">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                {{-- Step 1 --}}
                <div class="card-hover bg-gradient-to-br from-slate-800 to-slate-900 rounded-xl p-8 border border-slate-700 relative">
                    <div class="absolute top-6 right-6 w-12 h-12 bg-blue-500 rounded-full flex items-center justify-center text-white font-bold text-lg">
                        1
                    </div>
                    <div class="mb-6">
                    ...
                    <p class="text-gray-400">Jelajahi katalog lengkap kami dan pilih perlengkapan yang sesuai dengan kebutuhan acara Anda.</p>
                </div>
                ...
                <div class="card-hover bg-gradient-to-br from-slate-800 to-slate-900 rounded-xl p-8 border border-slate-700 relative">
                    ...
                    <p class="text-gray-400">Isi formulir pemesanan Anda, pilih tanggal rental, dan lakukan pembayaran dengan aman.</p>
                </div>
                ...
                <div class="card-hover bg-gradient-to-br from-slate-800 to-slate-900 rounded-xl p-8 border border-slate-700 relative">
                    ...
                    <p class="text-gray-400">Pilih opsi pengiriman ke lokasi acara Anda atau ambil langsung di kantor kami.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="about" class="py-20 bg-black">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                {{-- Reason 1 --}}
                <div class="card-hover flex gap-6 p-8 rounded-xl bg-gradient-to-br from-slate-900 to-slate-950 border border-slate-800">
                    ...
                    <div>
                        ...
                        <p class="text-gray-400">Semua peralatan kami dipilih dan dirawat dengan standar profesional tertinggi untuk memastikan kualitas terbaik.</p>
                    </div>
                </div>
                ...
                <div class="card-hover flex gap-6 p-8 rounded-xl bg-gradient-to-br from-slate-900 to-slate-950 border border-slate-800">
                    ...
                    <div>
                        ...
                        <p class="text-gray-400">Kami menawarkan paket harga yang kompetitif dan fleksibel sesuai dengan budget acara Anda.</p>
                    </div>
                </div>
                ...
                <div class="card-hover flex gap-6 p-8 rounded-xl bg-gradient-to-br from-slate-900 to-slate-950 border border-slate-800">
                    ...
                    <div>
                        ...
                        <p class="text-gray-400">Tim support kami siap membantu 24/7 untuk memastikan acara Anda berjalan lancar tanpa hambatan.</p>
                    </div>
                </div>
                ...
                <div class="card-hover flex gap-6 p-8 rounded-xl bg-gradient-to-br from-slate-900 to-slate-950 border border-slate-800">
                    ...
                    <div>
                        ...
                        <p class="text-gray-400">Kami telah melayani ratusan acara dengan kepuasan pelanggan yang tinggi dan track record terbaik.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="py-20 bg-slate-900">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                {{-- Testimonial 1 --}}
                <div class="card-hover bg-gradient-to-br from-slate-800 to-slate-900 rounded-xl p-8 border border-slate-700">
                    <div class="flex items-center mb-4">
                        <img src="https://i.pravatar.cc/150?img=12" alt="Pelanggan 1" class="w-14 h-14 rounded-full border-2 border-blue-500">
                        <div class="ml-4">
                ...
                <div class="card-hover bg-gradient-to-br from-slate-800 to-slate-900 rounded-xl p-8 border border-slate-700">
                    <div class="flex items-center mb-4">
                        <img src="https://i.pravatar.cc/150?img=22" alt="Pelanggan 2" class="w-14 h-14 rounded-full border-2 border-blue-500">
                        <div class="ml-4">
                    ...
                    <p class="text-gray-300">
                        "Paket lengkap lighting mereka membuat pernikahan saya terlihat spektakuler. Tim support mereka sangat responsif dan helpful. Terima kasih!"
                    </p>
                </div>
                ...
                <div class="card-hover bg-gradient-to-br from-slate-800 to-slate-900 rounded-xl p-8 border border-slate-700">
                    <div class="flex items-center mb-4">
                        <img src="https://i.pravatar.cc/150?img=32" alt="Pelanggan 3" class="w-14 h-14 rounded-full border-2 border-blue-500">
                        <div class="ml-4">
    ...
    <section class="py-24 bg-gradient-to-r from-slate-900 to-slate-950 relative overflow-hidden">
        <!-- Decorative elements -->
        <div class="absolute top-0 right-0 w-96 h-96 bg-blue-500 rounded-full mix-blend-multiply filter blur-3xl opacity-20 -mr-40"></div>
        <div class="absolute bottom-0 left-0 w-96 h-96 bg-cyan-500 rounded-full mix-blend-multiply filter blur-3xl opacity-20 -ml-40"></div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                ...
                <div>
                    ...
                    <div class="flex space-x-4">
                        <a href="#" class="w-10 h-10 rounded-lg bg-slate-800 hover:bg-blue-500 flex items-center justify-center transition-colors duration-300">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                        </a>
                        <a href="#" class="w-10 h-10 rounded-lg bg-slate-800 hover:bg-blue-500 flex items-center justify-center transition-colors duration-300">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M23 3a10.9 10.9 0 11-3.14 1.53 4.48 4.48 0 00.33-2.82v-.2A10.64 10.64 0 0023 3z"/></svg>
                        </a>
                        <a href="#" class="w-10 h-10 rounded-lg bg-slate-800 hover:bg-blue-500 flex items-center justify-center transition-colors duration-300">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><rect width="24" height="24" fill="none"/><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm3.5-9c.83 0 1.5-.67 1.5-1.5S16.33 8 15.5 8 14 8.67 14 9.5s.67 1.5 1.5 1.5zm-7 0c.83 0 1.5-.67 1.5-1.5S9.33 8 8.5 8 7 8.67 7 9.5 7.67 11 8.5 11zm3.5 6.5c2.33 0 4.31-1.46 5.11-3.5H6.89c.8 2.04 2.78 3.5 5.11 3.5z"/></svg>
                        </a>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        <li><a href="#home" class="text-gray-400 hover:text-blue-400 transition-colors duration-300">Beranda</a></li>
                        <li><a href="#products" class="text-gray-400 hover:text-blue-400 transition-colors duration-300">Produk</a></li>
                        <li><a href="#about" class="text-gray-400 hover:text-blue-400 transition-colors duration-300">Tentang Kami</a></li>
                        <li><a href="#contact" class="text-gray-400 hover:text-blue-400 transition-colors duration-300">Kontak</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        <li><a href="#" class="text-gray-400 hover:text-blue-400 transition-colors duration-300">Rental Harian</a></li>
                        <li><a href="#" class="text-gray-400 hover:text-blue-400 transition-colors duration-300">Paket Event</a></li>
                        <li><a href="#" class="text-gray-400 hover:text-blue-400 transition-colors duration-300">Pengiriman Gratis</a></li>
                        <li><a href="#" class="text-gray-400 hover:text-blue-400 transition-colors duration-300">Dukungan Teknis</a></li>
                    </ul>
                </div>
