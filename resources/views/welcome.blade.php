...
<body class="bg-gray-50 text-gray-900 antialiased selection:bg-blue-600 selection:text-white">
    ...
    <section id="products" class="py-24 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center max-w-3xl mx-auto mb-16 animate-on-scroll">
                ...
                <p class="text-lg text-gray-600">Pilih dari koleksi perlengkapan event premium kami yang selalu terawat
                    dan siap pakai.</p>
            </div>
    ...
    <section id="about" class="py-24 bg-white overflow-hidden">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center max-w-3xl mx-auto mb-16 animate-on-scroll">
                ...
                <p class="text-lg text-gray-600">Kami berkomitmen memberikan layanan terbaik untuk memastikan setiap
                    event Anda berjalan sempurna tanpa kendala teknis.</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="animate-on-scroll">
                    <div
                        ...
                        <p class="text-gray-600 text-sm leading-relaxed">Berbagai kebutuhan event tersedia, mulai dari
                            skala kecil hingga konser besar.</p>
                    </div>
                </div>
                <!-- Card 2 -->
                <div class="animate-on-scroll delay-100">
                    <div
                        ...
                        <p class="text-gray-600 text-sm leading-relaxed">Harga kompetitif dan transparan. Tidak ada
                            biaya
                            tersembunyi yang memberatkan.</p>
                    </div>
                </div>
                <!-- Card 3 -->
                <div class="animate-on-scroll delay-200">
                    <div
                        class="bg-gray-50 rounded-3xl p-8 hover:-translate-y-2 transition-transform duration-300 border border-gray-100">
                        <div
                            class="w-14 h-14 bg-purple-100 text-purple-600 rounded-2xl flex items-center justify-center mb-6">
                            <svg class="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <p class="text-gray-600 text-sm leading-relaxed">Proses rental cepat, sederhana, dan digital.
                            Pesan
                ...
                <div class="animate-on-scroll delay-300">
                    <div
                        ...
                        <p class="text-gray-600 text-sm leading-relaxed">Dikelola secara profesional dengan rekam jejak
                            menyukseskan ribuan acara.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="py-24 bg-gray-900 text-white overflow-hidden relative">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="text-center max-w-3xl mx-auto mb-20 animate-on-scroll">
                ...
                <p class="text-lg text-gray-400">Proses peminjaman barang kami desain semudah mungkin untuk menghemat
                    waktu Anda.</p>
            </div>
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center relative">
                ...
                <!-- Step 2 -->
                <div
                    class="flex flex-col items-center text-center w-full md:w-1/5 mb-10 md:mb-0 relative animate-on-scroll delay-100">
                    <div
                        class="w-16 h-16 rounded-full bg-gray-800 border-4 border-gray-900 flex items-center justify-center text-xl font-bold mb-4">
                        2</div>
                ...
                <!-- Step 3 -->
                <div
                    class="flex flex-col items-center text-center w-full md:w-1/5 mb-10 md:mb-0 relative animate-on-scroll delay-200">
                    <div
                        class="w-16 h-16 rounded-full bg-gray-800 border-4 border-gray-900 flex items-center justify-center text-xl font-bold mb-4">
                        3</div>
                ...
                <!-- Step 4 -->
                <div
                    class="flex flex-col items-center text-center w-full md:w-1/5 mb-10 md:mb-0 relative animate-on-scroll delay-300">
                    <div
                        class="w-16 h-16 rounded-full bg-gray-800 border-4 border-gray-900 flex items-center justify-center text-xl font-bold mb-4">
                        4</div>
                ...
                <!-- Step 5 -->
                <div
                    class="flex flex-col items-center text-center w-full md:w-1/5 relative animate-on-scroll delay-400">
                    <div
                        class="w-16 h-16 rounded-full bg-green-500 border-4 border-gray-900 flex items-center justify-center text-xl font-bold mb-4 shadow-lg shadow-green-500/50">
                        5</div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 animate-on-scroll">
                    ...
                    <p class="text-gray-600 mb-8 italic">"Sangat puas dengan pelayanan rental ini! Alatnya bersih,
                        terawat, dan kualitasnya benar-benar standar profesional. Event konser kami sukses besar berkat
                        sound system dari sini."</p>
                    <div class="flex items-center gap-4">
                        <img src="https://i.pravatar.cc/150?img=11" alt="Budi Santoso"
                ...
                <div class="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 animate-on-scroll delay-100">
                    ...
                    <p class="text-gray-600 mb-8 italic">"Sangat membantu! Kemarin butuh proyektor mendadak untuk
                        presentasi, proses rental cepat banget nggak ribet sama sekali. The best deh pokoknya."</p>
                    <div class="flex items-center gap-4">
                        <img src="https://i.pravatar.cc/150?img=47" alt="Siti Aminah"
                            class="w-12 h-12 rounded-full object-cover">
                        <div>
                ...
                <div class="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 animate-on-scroll delay-200">
                    ...
                    <p class="text-gray-600 mb-8 italic">"Peralatan lighting-nya juara! Acara pernikahan kami jadi
                        terlihat sangat mewah dan elegan. Harga sewa juga sangat masuk akal dibandingkan vendor lain."
                    </p>
                    <div class="flex items-center gap-4">
                        <img src="https://i.pravatar.cc/150?img=32" alt="Andi Pratama"
                            class="w-12 h-12 rounded-full object-cover">
                        <div>
    ...
    <section id="faq" class="py-24 bg-white">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16 animate-on-scroll">
                ...
                <p class="text-lg text-gray-600">Temukan jawaban untuk pertanyaan yang sering diajukan oleh pelanggan
                    kami.</p>
            </div>
            ...
            <div class="space-y-4 animate-on-scroll">
                ...
                <div class="border border-gray-200 rounded-2xl overflow-hidden faq-item">
                    <button
                        class="faq-btn w-full px-6 py-5 text-left flex justify-between items-center bg-gray-50 hover:bg-gray-100 transition focus:outline-none">
                        <span class="font-bold text-gray-900 text-lg">Bagaimana cara melakukan rental?</span>
                        <svg class="w-6 h-6 text-gray-500 transform transition-transform duration-300 icon"
                    ...
                    <div class="faq-content px-6 py-5 bg-white border-t border-gray-100">
                        <p class="text-gray-600">Anda dapat langsung melihat katalog produk, memilih barang yang
                            diinginkan, kemudian menghubungi nomor kami atau mendaftar dan memesan langsung melalui
                            sistem jika fitur tersebut diaktifkan.</p>
                    </div>
                </div>
                ...
                <div class="border border-gray-200 rounded-2xl overflow-hidden faq-item">
                    ...
                    <div class="faq-content px-6 py-5 bg-white border-t border-gray-100">
                        <p class="text-gray-600">Ya, kami menyediakan sistem DP (Down Payment) untuk mengamankan
                            pesanan barang Anda pada tanggal event. Pelunasan dapat dilakukan saat pengambilan barang.
                        </p>
                    </div>
                </div>
                ...
                <div class="border border-gray-200 rounded-2xl overflow-hidden faq-item">
                    <button
                        class="faq-btn w-full px-6 py-5 text-left flex justify-between items-center bg-gray-50 hover:bg-gray-100 transition focus:outline-none">
                        <span class="font-bold text-gray-900 text-lg">Bagaimana jika terlambat mengembalikan
                            barang?</span>
                        <svg class="w-6 h-6 text-gray-500 transform transition-transform duration-300 icon"
                            fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7">
                    ...
                    <div class="faq-content px-6 py-5 bg-white border-t border-gray-100">
                        <p class="text-gray-600">Keterlambatan pengembalian akan dikenakan denda sesuai dengan syarat
                            dan ketentuan yang berlaku. Biasanya dihitung sebagai perpanjangan masa sewa per hari.</p>
                    </div>
                </div>
                ...
                <div class="border border-gray-200 rounded-2xl overflow-hidden faq-item">
                    ...
                    <div class="faq-content px-6 py-5 bg-white border-t border-gray-100">
                        <p class="text-gray-600">Betul, sistem kami mencatat setiap transaksi sehingga ketersediaan
                            stok produk yang tampil di website selalu up-to-date dan real-time.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    {{-- Footer --}}
    <footer class="bg-black border-t border-slate-700 py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
